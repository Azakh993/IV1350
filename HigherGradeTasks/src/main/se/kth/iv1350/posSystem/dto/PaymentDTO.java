...
public class PaymentDTO {
	...
	/**
	 * Creates a new instance of <code>PaymentDTO</code> containing payment data Used for transactions where discount
	...
	/**
	 * Creates a new instance of <code>PaymentDTO</code> containing payment data Used for transaction where discount
	 * has
	 * been requested
	 * @param totalPrice              The total price for the items bought
	 * @param totalVAT                The total VAT for the items bought
