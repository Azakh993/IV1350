...
/**
 * A <code>DiscountStrategy</code> that calculates the eligible discount amount
 * based on total-based discounts.
 */
public class TotalBasedDiscount implements DiscountStrategy {

    /**
     * Algorithm for calculating the highest total-based discount one might be eligible for
     * based on the <code>totalPrice</code>
     *
     ...
     */
    public Amount processDiscount(DiscountDTO discountDTO, LinkedHashMap<ItemDTO, Amount> itemsInBasket, Amount totalPrice) {
