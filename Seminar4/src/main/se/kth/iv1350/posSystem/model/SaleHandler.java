...
public class SaleHandler {
    ...
    /**
     * Creates an instance of <code>SaleHandler</code>, and stores references to
     * new instances of <code>Basket</code> and <code>Payment</code>
     * Also sets <code>saleActive</code> to true
     */
    public SaleHandler() {
    ...
    /**
     * Sets items in the basket, either by adding the new item
     * or incrementing the previously registered item's quantity
     *
    ...
    /**
     * Sets the amount paid and the change (based on the <code>totalPrice</code>), and then generates
     * a <code>ReceiptDTO</code> object representing a receipt.
     * If discount has been applied, the receipt has added information with the discount data
     *
