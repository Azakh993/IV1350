 ...
 * based on item-based discounts.
 */
public class ItemBasedDiscount implements DiscountStrategy {

    /**
     * The algorithm for calculating the total item-based discount one might be eligible for
     * based on the <code>itemsInBasket</code>
     *
